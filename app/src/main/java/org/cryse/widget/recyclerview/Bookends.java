...
@SuppressWarnings({ "ALL", "AlibabaClassMustHaveAuthor" }) public class Bookends<T extends RecyclerView.Adapter> extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
