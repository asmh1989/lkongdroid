...
@SuppressWarnings({ "ALL", "AlibabaClassMustHaveAuthor" }) public class LKongAuthenticator extends AbstractAccountAuthenticator {
    ...
    public LKongAuthenticator(Context context) {
        super(context);
    ...
    public Bundle addAccount(AccountAuthenticatorResponse response, String accountType, String authTokenType, String[] requiredFeatures, Bundle options) throws NetworkErrorException {
        final Intent intent = new Intent(mContext, LKongAuthenticatorActivity.class);
        intent.putExtra(LKongAuthenticatorActivity.ARG_ACCOUNT_TYPE, accountType);
        intent.putExtra(LKongAuthenticatorActivity.ARG_AUTH_TYPE, authTokenType);
        intent.putExtra(LKongAuthenticatorActivity.ARG_IS_ADDING_NEW_ACCOUNT, true);
    ...
    public Bundle getAuthToken(AccountAuthenticatorResponse response, Account account, String authTokenType, Bundle options) throws NetworkErrorException {
        ...
        final Intent intent = new Intent(mContext, LKongAuthenticatorActivity.class);
        intent.putExtra(AccountManager.KEY_ACCOUNT_AUTHENTICATOR_RESPONSE, response);
        intent.putExtra(LKongAuthenticatorActivity.ARG_ACCOUNT_TYPE, account.type);
        intent.putExtra(LKongAuthenticatorActivity.ARG_AUTH_TYPE, authTokenType);
        intent.putExtra(LKongAuthenticatorActivity.ARG_ACCOUNT_NAME, account.name);
        final Bundle bundle = new Bundle();
        bundle.putParcelable(AccountManager.KEY_INTENT, intent);
        return bundle;
    }
