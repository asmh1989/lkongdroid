...
@SuppressWarnings({ "ALL", "AlibabaClassMustHaveAuthor" }) public class PostModel implements Parcelable {
    ...
    public PostDisplayCache getPostDisplayCache() {
        return postDisplayCache;
    }

    public void setPostDisplayCache(PostDisplayCache postSpanCache) {
        this.postDisplayCache = postSpanCache;
    }
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        dest.writeTypedList(this.rateLog);
    ...
    private PostModel(Parcel in) {
        ...
        this.rateLog = in.createTypedArrayList(PostRate.CREATOR);
