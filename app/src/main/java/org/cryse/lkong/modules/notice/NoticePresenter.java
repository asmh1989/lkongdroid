...
@SuppressWarnings({ "ALL", "AlibabaClassMustHaveAuthor" }) public class NoticePresenter extends SimpleCollectionPresenter<NoticeModel, SimpleCollectionView<NoticeModel>> {
