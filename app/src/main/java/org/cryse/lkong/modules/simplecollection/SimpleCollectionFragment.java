...
public abstract class SimpleCollectionFragment<
    ...
    protected AppNavigation mNavigation = new AppNavigation();
    ...
    protected AdapterType mCollectionAdapter;
    protected Bookends<AdapterType> mWrapperAdapter;

    protected List<ItemType> mItemList = new ArrayList<ItemType>();
