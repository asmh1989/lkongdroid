...
@SuppressWarnings({ "ALL", "AlibabaClassMustHaveAuthor" }) public class LKongWebConstants {
    ...
    public static final String FORUM_THREAD_LIST_URL = LKONG_DOMAIN_URL + "/forum/index.php?mod=data&sars=forum/%d%s";
    ...
    public static final String SEARCH_URL = LKONG_INDEX_URL + "?mod=data&sars=search/";
}
