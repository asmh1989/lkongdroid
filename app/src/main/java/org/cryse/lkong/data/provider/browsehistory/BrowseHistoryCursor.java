 ...
 */
@SuppressWarnings({ "ALL", "AlibabaClassMustHaveAuthor" }) public class BrowseHistoryCursor extends AbstractCursor implements BrowseHistoryModel {
     ...
     */
    @Override public long getLastReadTime() {
